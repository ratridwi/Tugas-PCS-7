package com.appkucing.app.data.local

import android.content.Context
import android.content.SharedPreferences
import com.appkucing.app.data.model.ActionState
import com.appkucing.app.data.model.AuthUser
import com.appkucing.app.util.getObject
import com.appkucing.app.util.putObject
...
class AuthPref(val context: Context) {
    ...
    suspend fun login(email: String, password: String): ActionState<AuthUser> {
        val user = authUser
        return if (user == null) {
            ActionState(message = "Anda Belum Daftar", isSuccess = false)
